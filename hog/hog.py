...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while rolls_left > 0:
        ...
        rolls_left -= 1
    return 1 if pig_out == True else turn_score
    # END PROBLEM 1
...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    score_difference = abs(score // 10 - score % 10)
    return 2 + score_difference
    # END PROBLEM 2
...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    assert opponent_score <= 100, 'The game should be over.' #changed < 100 to <= 100 to suit a case where score1 was 20 and score2 was 100 after the swap -- ok?
    # BEGIN PROBLEM 3
    if num_rolls == 0:
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        ...
        comments = comments(score0, score1)
        player = other(player)
    # # END PROBLEM 5
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        if who == 0:
            turn_score = score0 - previous_score
        else:
            turn_score = score1 - previous_score
        if turn_score <= previous_high:
            ...
            if new_high == 1:
                ...
                print(turn_score,"points! That's the biggest gain yet for Player",who)
        return announce_highest(who, new_high, previous_score + turn_score)
    return say
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    """
    # BEGIN PROBLEM 9
    # for 1 - 10 dice, find the value fo make_averaged, return the dice with the largest value
    potential_scores = []
    averaged_roll_dice = make_averaged(roll_dice, num_samples)
    for num in range(1, 11):
        potential_scores.append(averaged_roll_dice(num, dice))
    max_value = max(potential_scores)
    return potential_scores.index(max_value) + 1
    # END PROBLEM 9
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    if is_swap(free_bacon(opponent_score) + score,opponent_score) and free_bacon(opponent_score) + score < opponent_score:
        return 0
    else:
